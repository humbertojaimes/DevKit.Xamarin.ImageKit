...
namespace DevKit.Xamarin.ImageKit.Abstractions
{
    public interface IImageResizer
    {
        ...
        byte[] ScaleImage(byte[] originalImage, double finalImagePercentage, ImageFormat imageFormat);
        ...
        /// <param name="imageFormat">Image format Jpg or Png.</param>
        byte[] ResizeImage(byte[] originalImage, int newHeight, int newWidth, ImageFormat imageFormat);
        ...
        byte[] ReduceJPGQuality(byte[] originalImage, int newQuality);
    }
}